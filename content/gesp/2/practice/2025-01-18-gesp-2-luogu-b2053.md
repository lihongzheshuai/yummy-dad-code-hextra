---
layout: post
title: luogu-B2053 求一元二次方程
date: "2025-01-18T11:00:00+0800"
author: OneCoder
comments: true
tags:
- GESP
...
本题的关键是正确地应用一元二次方程的根公式，并且根据判别式的值来判断方程是否有实根。

首先，我们需要读取输入的系数 $a$, $b$, $c$，并计算判别式 $\Delta = b^2 - 4ac$。如果判别式非负，则方程有实根，我们可以计算 $\sqrt{\Delta}$，并根据以下公式计算两个根：

$$x_1 = \frac{-b + \sqrt{b^2 - 4ac}}{2a}, \quad x_2 = \frac{-b - \sqrt{b^2 - 4ac}}{2a}$$

然后，我们需要判断 $x_1$ 和 $x_2$ 是否相等。如果相等，则输出格式为 `x1=x2=aaaa`；否则，我们需要确保根小者在前，输出格式为 `x1=aaaa;x2=bbbb`。最后，如果判别式小于 $0$，则方程无实根，我们输出 `No answer!`。
