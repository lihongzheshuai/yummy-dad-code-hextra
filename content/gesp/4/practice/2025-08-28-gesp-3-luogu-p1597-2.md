...
在第一篇文章中([【GESP】C++三级练习 luogu-P1597 语句解析-系列题目1](/gesp/3/practice/gesp-3-luogu-p1597-1/))，我们完成P1597题目本身要求的讲解。同时，我们也留了一个扩展问题，在题目其他条件不变的情况下：
